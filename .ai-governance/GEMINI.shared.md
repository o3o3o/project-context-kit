...
1. **Read `.ai-governance/docs/project/context.md`** — ground yourself in what this project is and does.
2. **Read `.ai-governance/docs/task/active/task.md`** — understand the current task objective.
3. **Read `.ai-governance/docs/task/active/progress.md`** — know what has already been done.
4. **Read `.ai-governance/docs/task/active/handoff.md`** — see what the previous agent left for you.
...
1. **Append to `.ai-governance/docs/task/active/progress.md`** — write what you completed this session. Be specific.
2. **Rewrite `.ai-governance/docs/task/active/handoff.md`** — summarize current state and what to do next.
...
- **Code review** — review changes and write findings to `.ai-governance/docs/task/active/verification.md`
- **Debug assistance** — trace through errors, propose fixes, update handoff with findings
- **Q&A about the codebase** — answer questions grounded in `.ai-governance/docs/project/`
...
- Do not write canonical state anywhere except `.ai-governance/docs/task/active/` and `.ai-governance/docs/project/`
